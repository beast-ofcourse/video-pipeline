    ...
    nodes: [
      {
        ...
        constraints: { anchor: 'center', alignment: 'center', maxWidth: '95%' },
        ...
        metadata: { content: textConfig.text, fontSize: textConfig.fontSize * 1.5, fontWeight: textConfig.fontWeight, fontFamily: textConfig.fontFamily, color: textConfig.color },
      },
    ],
  }),
}
